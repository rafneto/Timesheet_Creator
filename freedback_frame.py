...
class FeedbackFrame(customtkinter.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        switch.grid(row=1, column=0, padx=0, pady=0, sticky="ns")

        self.label_feedback = customtkinter.CTkLabel(
            self, text="", text_color="#7FB785", anchor="w"
        )
        self.label_feedback.grid(row=2, column=0, padx=0, pady=0, sticky="ns")
    ...
    def switch_event(self):
        # TODO: implement translation switch option
        print("PDF in ", self.switch_var.get())
